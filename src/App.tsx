          ...
          <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
              <div className="sm:flex sm:items-center sm:justify-between">
                  ...
                  <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                      <li>
                          <a target='_blank' href="https://github.com/FabianCdx" className="hover:underline me-4 md:me-6">Fabian Sander-Pirva</a>
                      </li>
                      <li>
                          <a target='_blank' href="https://github.com/FabianCdx/FilmX" className="hover:underline me-4 md:me-6">About the Project</a>
                      </li>
                  </ul>
              </div>
